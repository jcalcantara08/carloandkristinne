            ...
            <label
              ...
              className={
                attending === option.value
                  ? "flex min-h-[52px] cursor-pointer items-center justify-center rounded-xl border border-brand-plum-500 bg-brand-plum-600/15 px-4 text-center text-sm font-medium text-brand-ink transition-colors duration-200"
