    ...
    >
      ...
      <div>
        ...
        <label
          ...
          className="mt-1 flex cursor-pointer flex-col items-center justify-center rounded-2xl border border-dashed border-brand-line-strong bg-brand-paper-100 px-6 py-10 text-center transition-colors duration-200 hover:border-brand-violet-500"
        >
          <ImagePlus className="h-7 w-7 text-brand-violet-500" aria-hidden="true" />
